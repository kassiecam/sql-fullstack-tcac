...
function ClientSearch() {
    ...
    return (
        <div className="clientSearch-app">
            <div className="clientSearch-container">
                <div className="clientSearch-left">
                ...
                <div className="clientSearch-right">
                    <div className="scrollSearch">
                        {returnedData.length > 0 ? (
                            <table>
                                <thead>
                                    <tr className="clientSearch-tableTitle-row">
                                        <th colSpan="8" className="clientSearch-tableTitle">Search Results</th>
                                    </tr>
                                    <tr>
                                        <th>Id</th>
                                        <th>First Name</th>
